...
final class JavaDependencyResolverTests: XCTestCase {
  ...
  static func publishSampleJavaProject(to repoDir: URL) throws {
    ...
    guard let gradlew = gradlewPath else {
      throw NSError(domain: "JavaDependencyResolverTests", code: 1, userInfo: [
    ...
    if process.terminationStatus != 0 {
      ...
      throw NSError(domain: "JavaDependencyResolverTests", code: Int(process.terminationStatus), userInfo: [
