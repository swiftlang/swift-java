...
* Commit hash
* Contextual information (e.g. what you were trying to achieve with swift-jni)
...
Please open a pull request at https://github.com/swiftlang/swift-jni. Make sure the CI passes, and then wait for code review.
