...
public class SwiftArrayAccessor<Wrapped extends SwiftInstance> {

    private final MemorySegment self$;
    private final SwiftAnyType wrappedType;

    public SwiftArrayAccessor(Arena arena,
    ...
    // FIXME: we can't get type "Array" as it has to be some SPECIFIC Array
//    public static final SwiftAnyType TYPE_METADATA =
//            new SwiftAnyType(SwiftKit.swiftjava.getType("Swift", "Array"));
//
