...
package enum JavaResolver {
  ...
  private static func resolveDependencies(
    ...
    let dependenciesClasspath = await resolveDependencies(workDir: workDir, dependencies: dependencies, repositories: repositories)
  ...
  private static func resolveDependencies(workDir: URL, dependencies: [JavaDependencyDescriptor], repositories: [JavaRepositoryDescriptor]) async -> String {
