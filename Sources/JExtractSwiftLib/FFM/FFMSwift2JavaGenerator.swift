...
extension FFMSwift2JavaGenerator {
  ...
  package func writeExportedJavaSources(printer: inout JavaPrinter) throws {
...
extension FFMSwift2JavaGenerator {
  ...
  func printModule(_ printer: inout JavaPrinter) {
    printHeader(&printer)
  ...
  func printImportedNominal(_ printer: inout JavaPrinter, _ decl: ExtractedNominalType) {
    printHeader(&printer)
    printPackage(&printer)
  ...
  func printHeader(_ printer: inout JavaPrinter) {
    printer.print(
      """
  ...
  func printPackage(_ printer: inout JavaPrinter) {
    printer.print(
      """
      package \(javaPackage);
  ...
  func printImports(_ printer: inout JavaPrinter) {
  ...
  func getSpecialNominalConstructorPrinting(_ decl: ExtractedNominalType) -> ((inout JavaPrinter) -> Void)? {
    if decl.swiftNominal.isSwiftJavaErrorType {
      return { printer in
  ...
  func getSpecialNominalPostMembersPrinting(_ decl: ExtractedNominalType) -> ((inout JavaPrinter) -> Void)? {
    if decl.swiftNominal.isSwiftJavaErrorType {
      return { printer in
  ...
  func printModuleClass(_ printer: inout JavaPrinter, body: (inout JavaPrinter) -> Void) {
  ...
  func printClassConstants(printer: inout JavaPrinter) {
    printer.print(
      """
  ...
  func printPrivateConstructor(_ printer: inout JavaPrinter, _ typeName: String) {
    printer.print(
      """
      private \(typeName)() {
  ...
  private func printClassMemoryLayout(_ printer: inout JavaPrinter, _ decl: ExtractedNominalType) {
    printer.print(
      """
  ...
  func printSpecificTypeHelpers(_ printer: inout JavaPrinter, _ decl: ExtractedNominalType) {
  ...
  func printSwiftJavaErrorFetchDescriptionMethod(_ printer: inout JavaPrinter, _ decl: ExtractedNominalType) {
