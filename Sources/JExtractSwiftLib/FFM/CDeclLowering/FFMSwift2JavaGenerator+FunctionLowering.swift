    ...
    if isAsync {
      ...
      asyncCompletionOutParameter = LoweredParameter(
        cdeclParameters: [
          SwiftParameter(
            ...
            type: knownTypes.optionalSugar(.function(completionType))
          )
        ],
        conversion: .placeholder
      )
      ...
      if isThrowing {
        let errorCompletionType = SwiftFunctionType(
          convention: .c,
          parameters: [
            SwiftParameter(convention: .byValue, type: knownTypes.optionalSugar(knownTypes.unsafePointer(knownTypes.int8)))
          ],
          resultType: .tuple([])
        )
        asyncErrorOutParameter = LoweredParameter(
          cdeclParameters: [
            SwiftParameter(
              ...
              type: knownTypes.optionalSugar(.function(errorCompletionType))
            )
          ],
          conversion: .placeholder
        )
