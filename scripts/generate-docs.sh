...
##
## Usage:
##   scripts/generate-docs.sh             build static HTML into .build/documentation
##   scripts/generate-docs.sh --preview   rebuild the config docs and launch the live DocC preview server
##
set -eu
